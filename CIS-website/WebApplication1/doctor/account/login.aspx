<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="WebApplication1.doctor.account.login" %>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
     ...
     <div id="container" style="margin-top:100px;">
        <form runat="server" class="form-horizontal">
            ...
            <div class="form-group"> 
                <div class="col-sm-offset-2 col-sm-10">
                    <asp:Button runat="server" id="ButtonLoginSubmit" type="submit" class="btn btn-default" Text="Submit" OnClick="ButtonLoginSubmit_Click1"/>
                </div>
            </div>
       </form>
    </div>
